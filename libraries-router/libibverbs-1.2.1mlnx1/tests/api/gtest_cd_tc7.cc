...
class tc_verbs_post_send_rdma_calc : public verbs_test_cd {};
...
/* tc_verbs_post_send_rdma_calc: [TI.1]
 * IBV_WR_RDMA_WRITE_WITH_IMM (LXOR)
 */
TEST_F(tc_verbs_post_send_rdma_calc, ti_1) {
...
/* tc_verbs_post_send_rdma_calc: [TI.2]
 * IBV_WR_RDMA_WRITE_WITH_IMM (BXOR)
 */
TEST_F(tc_verbs_post_send_rdma_calc, ti_2) {
...
/* tc_verbs_post_send_rdma_calc: [TI.3]
 * IBV_WR_RDMA_WRITE_WITH_IMM (LOR)
 */
TEST_F(tc_verbs_post_send_rdma_calc, ti_3) {
...
/* tc_verbs_post_send_rdma_calc: [TI.4]
 * IBV_WR_RDMA_WRITE_WITH_IMM (BOR)
 */
TEST_F(tc_verbs_post_send_rdma_calc, ti_4) {
...
/* tc_verbs_post_send_rdma_calc: [TI.5]
 * IBV_WR_RDMA_WRITE_WITH_IMM (LAND)
 */
TEST_F(tc_verbs_post_send_rdma_calc, ti_5) {
...
/* tc_verbs_post_send_rdma_calc: [TI.6]
 * IBV_WR_RDMA_WRITE_WITH_IMM (BAND)
 */
TEST_F(tc_verbs_post_send_rdma_calc, ti_6) {
...
/* tc_verbs_post_send_rdma_calc: [TI.7]
 * IBV_WR_RDMA_WRITE_WITH_IMM (ADD)
 */
TEST_F(tc_verbs_post_send_rdma_calc, ti_7) {
...
/* tc_verbs_post_send_rdma_calc: [TI.8]
 * IBV_WR_RDMA_WRITE_WITH_IMM (MAX)
 */
TEST_F(tc_verbs_post_send_rdma_calc, ti_8) {
...
/* tc_verbs_post_send_rdma_calc: [TI.9]
 * IBV_WR_RDMA_WRITE_WITH_IMM (MIN)
 */
TEST_F(tc_verbs_post_send_rdma_calc, ti_9) {
...
/* tc_verbs_post_send_rdma_calc: [TI.10]
 * IBV_WR_RDMA_WRITE_WITH_IMM (PROD)
 */
TEST_F(tc_verbs_post_send_rdma_calc, ti_10) {
...
static int pp_post_send(struct test_context *ctx)
{
	...
	if (ctx->calc_op.opcode != IBV_EXP_CALC_OP_NUMBER) {
		...
		wr.wr.rdma.remote_addr   = (uintptr_t)ctx->net_buf;
